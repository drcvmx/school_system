...
const studentGrades = [
  { id: "1", subject: "Matemáticas", value: 8.5, teacher: "Prof. Juan Pérez", date: "2023-10-15" },
  { id: "2", subject: "Ciencias", value: 9.2, teacher: "Profa. María López", date: "2023-10-12" },
  { id: "3", subject: "Historia", value: 7.8, teacher: "Prof. Carlos Gómez", date: "2023-10-10" },
  { id: "4", subject: "Lenguaje", value: 8.0, teacher: "Profa. Ana Rodríguez", date: "2023-10-08" },
  { id: "5", subject: "Arte", value: 9.5, teacher: "Prof. Roberto Sánchez", date: "2023-10-05" },
]
...
export function StudentDashboard() {
  ...
  const handleDownloadReport = () => {
    toast({
      ...
      description: "Tu boleta de calificaciones se está descargando",
    })
  }
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Grupo: {user?.grupo} - Ciclo Escolar: {user?.ciclo}
          </p>
        </div>
      ...
      <Tabs defaultValue="table" className="space-y-4">
        <TabsList>
          <TabsTrigger value="table">Tabla de Calificaciones</TabsTrigger>
      ...
      {/* Añadimos el botón aquí, al final del dashboard */}
